// Program: detectPatchesAndClones.ijm
// Version: 1
// Programming language: ImageJ Macro
// Description: Scans different parameters (brightness, contrast, threshold) and applies different edge-enhancement methods to identify potential edited regions. Furthermore, performs automatic (and user-adjusted) detection of "cloned" particles.
